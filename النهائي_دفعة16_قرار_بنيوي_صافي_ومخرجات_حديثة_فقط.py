...
DYNAMIC_SETTINGS: Dict[str, Any] = {
    ...
    "PRE_FILTER_MIN_24H_QUOTE_VOLUME": 150_000.0,
    "PRE_FILTER_MIN_24H_TRADE_COUNT": 80,
...
def build_why_not_detected_audit(result: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "summary_ar": "لا يوجد مانع واضح؛ الإشارة كانت قابلة للتنفيذ." if actionable else (" | ".join(blockers) if blockers else "لم يتم تحديد مانع وحيد؛ الرفض تراكمي."),
    }
