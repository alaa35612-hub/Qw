...
def evaluate_pre_rise_market_decision_tree(
    ...
    elif acc_lead >= FAMILY_RULES["ACCOUNT_LED_ACCUMULATION"]["account_lead_min"] and oi_supportive and price_rejecting_down:
        final_case = "ACCOUNT_LED_ACCUMULATION"
    elif pos_lead >= FAMILY_RULES["POSITION_LED_SQUEEZE_BUILDUP"]["position_lead_min"] and oi_supportive and (lower_extreme_active or divergence or price_rejecting_down):
    ...
    summary_ar = (
        f"pre-move={ 'نعم' if price_rejecting_down else 'لا' } | funding={funding_context} | "
...
def analyze_symbol_structural(
    ...
    try:
        ...
        tree_to_hypothesis = {
            ...
            "FLOW_LIQUIDITY_VACUUM_BREAKOUT": "counterflow_short_squeeze_expansion",
