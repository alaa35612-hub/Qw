...
def bucket_for_result(result: StructuralResult) -> DisplayBucket:
    ...
    if classification == FinalClassification.CONSENSUS:
        return DisplayBucket(4, "الحالة 4: توسع صاعد توافقي غير مزدحم", ANSI_WHITE)
    ...
    if classification in {
        ...
        return DisplayBucket(5, "القاعدة الذهبية: تهيؤ + قيادة مراكز + تدفق داعم + قبول", ANSI_WHITE)

    return DisplayBucket(9, "حالات هيكلية مهمة أخرى", ANSI_WHITE)
